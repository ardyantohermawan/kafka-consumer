...
var (
	...
	zookeeper      = flag.String("zookeeper", DefaultZookeeperCluster, "A comma-separated Zookeeper connection string (e.g. `zookeeper1.local:2181,zookeeper2.local:2181,zookeeper3.local:2181`)")
